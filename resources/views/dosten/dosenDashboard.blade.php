...
<head>
  ...
  {{-- Dashboard CSS --}}
  <link rel="stylesheet" href="{{ asset('css/dashboard_dosen.css') }}">
</head>
...
<body>
      ...
      <div class="content">
        ...
        <div class="welcome-banner">
          ...
          <div class="welcome-text">
            <div class="greeting">Selamat datang kembali, Dosen</div>
            <div class="title">Portal Dosen, Sistem Kepegawaian FT-UNRI</div>
            <div class="subtitle">
            ...
            <div class="profile-meta">
              ...
              <div class="profile-chips">
                <span class="chip">
                  ...
                  NIP: <span id="profileNip">—</span>
                </span>

                <span class="chip">
                  <i class="bi bi-award"></i>
                  <span id="profileJabfung">—</span>
                </span>

                <span class="chip">
                  <i class="bi bi-building"></i>
                  <span id="profileHomebase">—</span>
                </span>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="charts-grid">
            ...
            <div class="chart-card">
              <div class="chart-title">Jabatan Fungsional</div>
              <div class="chart-subtitle">Posisi jabatan akademik Anda saat ini</div>
              <div class="chart-wrap">
                <canvas id="chartJabfung"></canvas>
              </div>
              <div class="legend-row" id="legendJabfung"></div>
            </div>
  ...
  {{-- Dashboard JS --}}
  <script src="{{ asset('js/dashboard_dosen.js') }}"></script>
</body>
