...
<head>
    ...
    <title>Edit Pengajuan Surat Tugas</title>
            ...
            <main class="content-area">
                ...
                <div class="page-header mb-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="page-title mb-0">Edit Pengajuan Surat Tugas</h4>
                            <p class="page-sub mb-0">
                                Perbarui data pengajuan surat tugas yang masih berstatus menunggu
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="intro-banner">
                    ...
                    <div class="intro-banner-text">
                        <h5>Perbarui Surat Tugas</h5>
                        <p>
                            Data hanya dapat diperbarui selama status pengajuan masih menunggu.
                        </p>
                    </div>
                </div>
                ...
                <div class="req-info">
                    ...
                    <ul>
                        ...
                        <li>Berkas pendukung boleh dikosongkan jika tidak ingin mengganti file.</li>
                        <li>Berkas baru wajib berformat PDF/JPG/PNG dengan ukuran maksimal 2 MB.</li>
                    </ul>
                </div>
                ...
                <div class="form-card">
                    <div class="card-header-strip">
                        ...
                        Form Edit Pengajuan Surat Tugas
                    </div>

                    <form id="formSuratTugas" action="{{ route('dosten.surtug.update', $pengajuan->id_pengajuan) }}"
                        method="POST" enctype="multipart/form-data" class="form-body" data-mode="edit">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="text" id="nama_pengusul" name="nama_pengusul" class="field-input"
                                        value="{{ old('nama_pengusul', $suratTugas->nama_pengusul ?? '') }}"
                                        maxlength="50" placeholder="Masukkan nama lengkap pengusul">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="date" id="waktu_pelaksana" name="waktu_pelaksana"
                                        class="field-input"
                                        value="{{ old('waktu_pelaksana', $suratTugas->waktu_pelaksana ?? '') }}">
                                ...
                                <div class="field-group">
                                    ...
                                    <input type="number" id="lama_pelaksanaan" name="lama_pelaksanaan"
                                        class="field-input"
                                        value="{{ old('lama_pelaksanaan', $suratTugas->lama_pelaksanaan ?? '') }}"
                                        min="1" max="999" placeholder="Contoh: 2">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="field-group">
                                    ...
                                    <textarea id="perihal" name="perihal" class="field-input textarea-input" maxlength="50"
                                        placeholder="Masukkan perihal surat">{{ old('perihal', $suratTugas->perihal ?? '') }}</textarea>
                                ...
                                <div class="field-group">
                                    ...
                                    @if (!empty($suratTugas->berkas_pendukung))
                                        <div class="mt-2">
                                            <small class="text-muted d-block mb-1">Berkas saat ini:</small>

                                            <a href="{{ asset('berkas/surat_tugas/' . $suratTugas->berkas_pendukung) }}"
                                                target="_blank" class="btn btn-sm btn-outline-danger">
                                                <i class="bi bi-file-earmark-pdf-fill me-1"></i>
                                                {{ $suratTugas->berkas_pendukung }}
                                            </a>
                                        </div>
                                    @endif
                                </div>
