...
<head>
    ...
    <title>Edit Berkas Pangkat Golongan — FT UNRI</title>
        ...
        <main class="content-area">
            ...
            <div class="page-header mb-4">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h4 class="page-title mb-0">Edit Berkas Pangkat Golongan</h4>
                        <p class="page-sub mb-0">Lengkapi berkas perubahan data riwayat pangkat dan golongan dosen</p>
                    </div>
                </div>
            </div>
            ...
            <div class="form-card">
                <div class="card-header-strip">
                    <i class="bi bi-pencil-square fuel me-2"></i>Form Perubahan Berkas Dokumen
                </div>
                
                <form id="formEditPanggol" action="{{ url('/pengajuan/panggol/update/' . $data->id_pangkat_golongan) }}" class="form-body" data-id="{{ $data->id_pangkat_golongan }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <div class="field-group">
                                <label class="field-label">
                                    <i class="bi bi-layers me-1"></i>Pangkat / Golongan Baru yang Diajukan
                                </label>
                                <input type="text" class="field-input field-readonly" value="{{ $data->pangkat_baru }}" readonly>
                                <small class="text-muted mt-1 d-block">*Pangkat pilihan tidak dapat diubah kembali.</small>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="field-group">
                                <label class="field-label">
                                    <i class="bi bi-calendar-event me-1"></i>TMT (Terhitung Mulai Tanggal)
                                </label>
                                <input type="text" class="field-input field-readonly" value="{{ $data->tmt }}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="alert alert-warning py-2 px-3 border-0 rounded-3 mb-1" style="font-size: 13px;">
                        ...
                        <div class="col-md-6">
                            <div class="field-group">
                                ...
                                @if(!empty($data->dokumen_sk_cpns))
                                    <div class="mt-2">
                                        <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1" style="font-size: 12px; font-weight: 500;">
                                            <i class="bi bi-check-circle-fill me-1"></i>Berkas sudah tersimpan di sistem
                                        </span>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="field-group">
                                ...
                                <span class="field-error"><small class="text-muted">Format: PDF, Maks. 5MB</small></span>
                                @if(!empty($data->dokumen_publikasi_ilmiah))
                                    <div class="mt-2">
                                        <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1" style="font-size: 12px; font-weight: 500;">
                                            <i class="bi bi-check-circle-fill me-1"></i>Berkas sudah tersimpan di sistem
                                        </span>
                    ...
                    <div class="action-bar mt-4">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ url('/dosen/pengajuan/panggol/edit/' . $item->id) }}" class="btn btn-warning">
                                Edit
                            </a>
...
<script>
// AJAX Handler Form Edit Panggol
document.getElementById('formEditPanggol').addEventListener('submit', function(e) {
    ...
    Swal.fire({
        title: 'Mohon Tunggu',
        text: 'Sedang memproses pembaruan berkas pangkat...',
    ...
    fetch(`/pengajuan/panggol/update/${idPengajuan}`, {
        method: 'POST',
        body: formData,
        headers: {
