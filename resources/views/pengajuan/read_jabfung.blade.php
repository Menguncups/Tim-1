    ...
    <div class="wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-brand">
                <img src="{{ asset('unriteknik.png') }}" alt="Logo FT UNRI">
            </div>
            ...
            <main class="content-area">
                ...
                <div class="profile-hero">
                    <div class="hero-top">
                        ...
                        <div class="hero-info">
                            <div class="hero-name">Edi Susilo, S.Pd., M.Kom.</div>
                            <div class="hero-nip">NIP: 199110292019031010</div>
                            <div class="hero-tags">
                                <span class="hero-tag"><i class="bi bi-building"></i> Teknik Informatika</span>
                                <span class="hero-tag"><i class="bi bi-upc"></i> NIDN: 0012345678</span>
                                <span class="hero-tag"><i class="bi bi-award"></i> Jabatan Fungsional</span>
                            </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if(collect($files)->filter()->count() > 0)
                                            @foreach($files as $file)
                                                @if($file)
                                                    <a href="{{ asset('storage/' . $file) }}" target="_blank" style="display:block; font-size: 13px;">
                                    ...
                                    <td>
                                        <div class="aksi-group">
                                            @if(!$item->pengajuan || $item->pengajuan?->status == 'menunggu' || $item->pengajuan?->status == 'draft')
                                            ...
                                            @else
                                                <button class="btn-action" disabled title="Terkunci">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-4 text-muted">
                                        ...
                                        Belum ada data riwayat jabatan fungsional di database.
                                    </td>
                                endtr>
                                @endforelse
                            </tbody>
            ...
            <footer class="site-footer">
                <div class="footer-left">
                    <div class="footer-logo-wrap">
                        <img src="{{ asset('unriteknik.png') }}" alt="Logo FT">
                    </div>
