...
<head>
    ...
    <title>Persetujuan Jabatan Fungsional</title>
            ...
            <div class="page-content">
                ...
                <div class="du-page-header">
                    <div class="du-header-left">
                        ...
                        <div>
                            <h4 class="du-page-title">Persetujuan Jabatan Fungsional</h4>
                            <p class="du-page-sub">Kelola pengajuan jabatan fungsional yang telah diproses operator</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="du-table-wrap">
                    <table id="tabelPimpinanJabfung" class="display w-100 tabel-pimpinan" data-status-column="7">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Pengaju</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="du-actions">
                                            ...
                                            <form action="{{ route('pimpinan.jabfung.terima', $item->id_pengajuan) }}"
                                                method="POST" class="d-inline form-terima-jabfung"
                                                data-nama="{{ $item->nama }}">
                                                @csrf
                                                @method('PUT')
                                            ...
                                            <form action="{{ route('pimpinan.jabfung.tolak', $item->id_pengajuan) }}"
