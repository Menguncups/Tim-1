...
<head>
    ...
    <title>Data Diri Tendik - SISTER</title>
    ...
    <style>
        ...
        #sidebar { width: 280px; height: 100vh; position: fixed; top: 0; left: 0; background-color: var(--sidebar-bg); border-right: 1px solid var(--border); z-index: 1000; }
        .sidebar-brand { padding: 24px; font-size: 20px; font-weight: 800; color: var(--primary); border-bottom: 1px solid var(--border); }
        .nav-link-custom { display: flex; align-items: center; gap: 12px; padding: 14px 24px; color: var(--text-muted); text-decoration: none; font-weight: 600; }
        .nav-link-custom.active { color: var(--primary); background-color: var(--primary-light); }
        #main-content { margin-left: 280px; padding: 40px; min-height: 100vh; }
        .profile-card { background: var(--card-bg); border-radius: var(--radius-card); border: 1px solid var(--border); padding: 30px; }
        .hero-avatar img { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; }
        ...
        @media (max-width: 991.98px) { #sidebar { transform: translateX(-100%); } #sidebar.open { transform: translateX(0); } #main-content { margin-left: 0; padding: 20px; } }
    </style>
</head>
<body>
    ...
    <div id="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h4 class="fw-bold mb-0">Profil Tendik</h4>
            <a href="{{ route('pegawai.edit', 'tendik') }}" class="btn btn-danger px-4" style="background-color: var(--primary); border: none;">
        ...
        <div class="profile-card mb-4">
            <div class="d-flex align-items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0"><i class="bi bi-card-text me-1"></i> NIP. {{ $pegawai->nip }} | <span class="badge bg-success text-white">Tendik</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="profile-card">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="info-label">Homebase (Unit Kerja)</div>
