...
<head>
    ...
    <title>Perbarui Data Diri Tendik</title>
...
<body>
    ...
    <div id="sidebar">
        ...
        <div class="py-3">
            <a href="{{ route('pegawai.read', 'tendik') }}" class="nav-link text-dark p-3 px-4 fw-semibold"><i class="bi bi-arrow-left me-2"></i> Kembali</a>
        </div>
    </div>

    <div id="main-content">
        <div class="mb-4">
            <h4 class="fw-bold">Perbarui Data Diri Tendik</h4>
            <p class="text-muted">Perubahan data kontak operasional Tenaga Kependidikan.</p>
        </div>

        <div class="update-card">
            <form id="formUpdateTendik" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    <div class="col-md-7">
                        ...
                        <button type="submit" class="btn btn-success px-4" style="background-color: #198754; border:none;"><i class="bi bi-save me-2"></i> Simpan Data Tendik</button>
                    </div>
    ...
    <script>
        ...
        document.getElementById('formUpdateTendik').addEventListener('submit', function(e) {
            e.preventDefault();
            fetch("{{ route('pegawai.update', 'tendik') }}", {
                method: 'POST',
            ...
            .then(data => {
                if(data.success) {
                    ...
                    .then(() => window.location.href = "{{ route('pegawai.read', 'tendik') }}");
                }
            });
        });
    </script>
