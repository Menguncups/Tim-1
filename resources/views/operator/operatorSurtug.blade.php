...
<body>
            ...
            <div class="page-content">
                ...
                <div class="du-page-header">
                    <div class="du-header-left">
                        ...
                        <div>
                            <h4 class="du-page-title">Validasi Surat Tugas</h4>
                            <p class="du-page-sub">Kelola pengajuan surat tugas pegawai Fakultas Teknik</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="du-table-wrap">
                    <table id="tabelSurtug" class="display w-100" data-status-column="7">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Pengaju</th>
    ...
    <script src="{{ asset('js/operatorSurtug.js') }}"></script>
