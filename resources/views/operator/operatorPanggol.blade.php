...
<head>
    ...
    <title>Validasi Pangkat Golongan</title>
            ...
            <div class="page-content">
                ...
                <div class="du-page-header">
                    <div class="du-header-left">
                        ...
                        <div>
                            <h4 class="du-page-title">Validasi Pangkat Golongan</h4>
                            <p class="du-page-sub">Kelola pengajuan perubahan pangkat dan golongan pegawai</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="du-table-wrap">
                    <table id="tabelPanggol" class="display w-100" data-status-column="7">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Pengaju</th>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="du-actions">
                                            ...
                                            {{-- PROSES --}}
                                            <form action="{{ route('operator.panggol.proses', $item->id_pengajuan) }}"
                                                method="POST" class="d-inline form-proses-panggol"
                                                data-nama="{{ $item->nama }}">
                                                @csrf
                                                @method('PUT')
                                            ...
                                            @if ($status === 'menunggu')
                                                <form
                                                    action="{{ route('operator.panggol.tolak', $item->id_pengajuan) }}"
                                                    method="POST" class="d-inline form-tolak-panggol"
                                                    data-nama="{{ $item->nama }}">
                                                    @csrf
                                                    @method('PUT')
                ...
                <div class="modal fade" id="modalDetailPanggol" tabindex="-1"
                    aria-labelledby="modalDetailPanggolLabel" aria-hidden="true">
                            ...
                            <div class="modal-body detail-modal-body">
                                ...
                                <div class="detail-grid mt-4">
                                    ...
                                    <div class="detail-item">
                                        ...
                                        <strong id="detailPanggolNamaPegawai">-</strong>
                                    </div>

                                    <div class="detail-item">
                                        <span>Email</span>
                                        <strong id="detailPanggolEmail">-</strong>
                                    </div>

                                    <div class="detail-item">
                                        <span>NIP</span>
                                        <strong id="detailPanggolNip">-</strong>
                                    </div>

                                    <div class="detail-item">
                                        <span>Homebase</span>
                                        <strong id="detailPanggolHomebase">-</strong>
                                    </div>
                                    ...
                                    <div class="detail-item">
                                        <span>Status</span>
                                        <strong id="detailPanggolStatusText">-</strong>
                                    </div>
