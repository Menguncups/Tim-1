...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-area">
                                ...
                                <td class="text-center">
                                    <div class="du-actions">
                                        ...
                                        <button type="button" class="du-act du-act-view btn-detail-pegawai"
                                            title="Detail" data-bs-toggle="modal" data-bs-target="#modalDetailPegawai"
            ...
            <div class="modal fade" id="modalDetailPegawai" tabindex="-1" aria-labelledby="modalDetailPegawaiLabel"
                aria-hidden="true">
